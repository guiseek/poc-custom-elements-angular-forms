import { Component, h, Prop, Element, State, Event, Watch } from '@stencil/core';
...
@Component({
  tag: 'nxc-color-picker',
  styleUrl: 'nxc-color-picker.scss',
  shadow: true,
})
export class NxcColorPicker {
  bypassValueParse = false;
  copyButton: HTMLNxcButtonElement;
  dropdown: HTMLNxcDropdownElement;
  lastValueEmitted: string;
  menu: HTMLElement;
  textInput: HTMLNxcInputElement;
  trigger: HTMLElement;

  @Element() host: HTMLNxcColorPickerElement;
  ...
  handleDocumentMouseDown(event: MouseEvent) {
    ...
    if (target.closest('nxc-color-picker') !== this.host) {
      this.dropdown.hide();
    }
  }
  ...
  render() {
      ...
      return (
        ...
        >
          ...
          <div class="color-picker__user-input">
            ...
            >
              <nxc-icon name={this.showCopyCheckmark ? 'check2' : 'clipboard'} />
            </nxc-button>
          </div>
    ...
    return (
      <nxc-dropdown
        ...
        onNxcShow={this.handleDropdownShow}
        onNxcAfterShow={this.handleDropdownAfterShow}
        onNxcHide={this.handleDropdownHide}
        onNxcAfterHide={this.handleDropdownAfterHide}
      >
        <button
